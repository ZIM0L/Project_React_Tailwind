            ...
            <div className=" max-w-6xl mx-auto px-5 mt-32 text-center">
                ...
                <div className="flex flex-col mt-10 md:flex-row md:space-x-6">
                    ...
                    <div className="flex flex-col items-center p-6 space-y-6 rounded-lg md:w-1/3">
                        <img src="src\assets\avatar-anisha.png" className=" w-16 " alt="" />
                    ...
                    {/* 2 Person */}
                    <div className="hidden flex-col items-center p-6 space-y-6 rounded-lg md:w-1/3 md:flex">
                        <img src="src\assets\avatar-ali.png" className=" w-16 " alt="" />
                    ...
                    {/* 3 Person */}
                    <div className="hidden  flex-col items-center p-6 space-y-6 rounded-lg md:w-1/3 md:flex">
                        <img src="src\assets\avatar-richard.png" className=" w-16 " alt="" />
